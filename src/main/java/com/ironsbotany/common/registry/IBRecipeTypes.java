...
import com.ironsbotany.common.recipe.IBSpellScrollRecipe;
...
public class IBRecipeTypes {
    ...
    public static final RegistryObject<RecipeSerializer<IBSpellScrollRecipe>> IB_SPELL_SCROLL_SERIALIZER =
        RECIPE_SERIALIZERS.register("ib_spell_scroll", IBSpellScrollRecipe.Serializer::new);
